...
impl Deck {
    ...
    pub fn peek_last(&mut self) -> Option<&Card> {
        self.deck.first()
    }
...
#[wasm_bindgen]
pub fn card_unicode(card: Card) -> String {
    use Rank::*;
    use Suit::*;
...
fn suit_fmt(suit: Suit) -> &'static str {
    match suit {
        Suit::Spades => "\u{2660}",
        Suit::Hearts => "\u{2665}",
